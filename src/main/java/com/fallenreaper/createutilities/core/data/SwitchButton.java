...
public class SwitchButton extends AbstractSimiWidget {
    ...
    protected Interactable.IClickable runClick = ($$, $_, $$_, $) -> {};
    protected Interactable.IDraggable runDrag = ($$, $_, $$_, $) -> {};
    ...
    public void setCallBack(Interactable.IDraggable _$_, Interactable.IClickable $_$) {
        this.runDrag = _$_;
        this.runClick = $_$;
    }
