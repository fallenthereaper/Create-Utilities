...
public class EncasedNixieTubeRenderer extends SafeTileEntityRenderer<EncasedNixieTubeBlockEntity> {

    private static Random r = new Random();

    public EncasedNixieTubeRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    protected void renderSafe(EncasedNixieTubeBlockEntity te, float partialTicks, PoseStack ms, MultiBufferSource buffer,
        ...
        float height = face == DoubleAttachFace.CEILING ? 1 : 6;
        float scale = 1 / 20f;

        Couple<String> s = te.getDisplayedStrings();
        DyeColor color = EncasedNixieTubeBlock.colorOf(te.getBlockState());
