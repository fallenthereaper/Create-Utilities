...
public class ArmorMaterials implements ArmorMaterial {
    ...
    private ArmorMaterials(String name, int maxDamageFactor, int[] damageReductionAmount, int enchantability,
    ...
    public static ArmorMaterials create(String name, int maxDamageFactor, int[] damageReductionAmount, int enchantability,
                                        SoundEvent soundEvent, float toughness, float knockbackResistance, Supplier<Ingredient> repairMaterial) {
        return new ArmorMaterials(name,maxDamageFactor, damageReductionAmount, enchantability, soundEvent, toughness, knockbackResistance, repairMaterial);
    }
    ...
    public String getName() {
        return CreateUtilities.ID + ":" + this.name;
    }
